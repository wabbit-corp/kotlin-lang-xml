...
// managed-integrity-v1: YmfmFdgWgA7
//
...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-lang-xml", project.version.toString())
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-lang-xml")
        description.set("kotlin-lang-xml")
        url.set("https://github.com/wabbit-corp/kotlin-lang-xml")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/wabbit-corp/kotlin-lang-xml")
            connection.set("scm:git:git://github.com/wabbit-corp/kotlin-lang-xml.git")
            developerConnection.set("scm:git:ssh://git@github.com/wabbit-corp/kotlin-lang-xml.git")
        }
    }
}
...
publishing {
    publications.withType<org.gradle.api.publish.maven.MavenPublication>().configureEach {
        val configuredArtifactId = "kotlin-lang-xml"
    ...
    sourceSets {
        val commonMain by getting {
            dependencies {
                ...
                api("one.wabbit:kotlin-parsing-charinput:1.2.0")
        ...
        extensions.findByType(DokkaExtension::class)?.apply {
            ...
            dokkaSourceSets.configureEach {
                ...
                sourceLink {
                    ...
                    remoteUrl("https://github.com/wabbit-corp/kotlin-lang-xml/tree/master/src")
