...
kover {
    ...
    //             // title.set("kotlin-lang-xml Code Coverage") // Uncomment to customize title
    //         }
    //         xml {
...
dokka {
    moduleName.set("kotlin-lang-xml")
    ...
    dokkaSourceSets.main {
        ...
        sourceLink {
            ...
            remoteUrl("https://github.com/wabbit-corp/kotlin-lang-xml/tree/master/src/main/kotlin")
